...
public class ListGender extends javax.swing.JDialog {
    ...
    public void GenderList() throws SQLException{
        ResultSet r = connection_sqldb.DataBaseConnection.getGenders();
        DefaultTableModel dtb = (DefaultTableModel) jTableGenders.getModel();
        while(r.next()){
            dtb.addRow(new Object[]{r.getInt("ID_GENDER"), r.getString("GENDER_NAME")});
        }
    }
    
    public void GenderCleanList(){
        DefaultTableModel dtb = (DefaultTableModel) jTableGenders.getModel();
    ...
    private void initComponents() {
        ...
        jTableGenders = new javax.swing.JTable();
        ...
        jTableGenders.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jTableGenders.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jScrollPane2.setViewportView(jTableGenders);
    ...
    private void jButtonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditActionPerformed
        Integer current_row = jTableGenders.getSelectedRow();
        if(current_row != -1){
            InsertGender dialog = new InsertGender(new javax.swing.JFrame(), true,  Integer.parseInt(String.valueOf(jTableGenders.getValueAt(current_row, 0))));
    ...
    private void jButtonInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonInsertActionPerformed
        InsertGender dialog = new InsertGender(new javax.swing.JFrame(), true, 0);
        dialog.setVisible(true);
        try{
            GenderCleanList();
            GenderList();
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        ...
        if(current_row != -1){
            try{
                connection_sqldb.DataBaseConnection.deleteGender((Integer) jTableGenders.getValueAt(current_row, 0));
                GenderCleanList();
                GenderList();
            }
            catch (SQLException e){
    ...
    private javax.swing.JTable jTableGenders;
