...
public class ListCompany extends javax.swing.JDialog {

    public ListCompany(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void CompanyList() throws SQLException{
        ResultSet r = connection_sqldb.DataBaseConnection.getCompanies();
        DefaultTableModel dtb = (DefaultTableModel) jTableCompanies.getModel();
        while(r.next()){
            dtb.addRow(new Object[]{r.getInt("ID_COMPANY"), r.getString("COMPANY_NAME")});
        }
    }
    ...
    private void initComponents() {
        ...
        jTableCompanies.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jTableCompanies.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jScrollPane2.setViewportView(jTableCompanies);
    ...
    private void jButtonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditActionPerformed
        ...
        if(current_row != -1){
            InsertCompany dialog = new InsertCompany(new javax.swing.JFrame(), true,  Integer.parseInt(String.valueOf(jTableCompanies.getValueAt(current_row, 0))));
    ...
    private void jButtonInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonInsertActionPerformed
        InsertCompany dialog = new InsertCompany(new javax.swing.JFrame(), true, 0);
        dialog.setVisible(true);
        try{
            CompanyCleanList();
            CompanyList();
