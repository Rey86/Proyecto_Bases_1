...
public class ListBanReason extends javax.swing.JDialog {
    
    public ListBanReason(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
public void BanReasonList() throws SQLException{
        ResultSet r = connection_sqldb.DataBaseConnection.getBanReasons();
        DefaultTableModel dtb = (DefaultTableModel) jTableBanReasons.getModel();
        while(r.next()){
            dtb.addRow(new Object[]{r.getInt("ID_BANREASON"), r.getString("BANREASON_DESCRIPTION")});
        }
    }
    ...
    private void initComponents() {
        ...
        jTableBanReasons = new javax.swing.JTable();
        ...
        jTableBanReasons.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jTableBanReasons.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jScrollPane2.setViewportView(jTableBanReasons);
        ...
        jLabel1.setText("Motivo de Baneo");
    ...
    private void jButtonInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonInsertActionPerformed
        InsertBanReason dialog = new InsertBanReason(new javax.swing.JFrame(), true, 0);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        Integer current_row = jTableBanReasons.getSelectedRow();
        if(current_row != -1){
            try{
                connection_sqldb.DataBaseConnection.deleteBanReason((Integer) jTableBanReasons.getValueAt(current_row, 0));
                BanReasonCleanList();
                BanReasonList();
            }
            catch (SQLException e){
    ...
    private void jButtonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditActionPerformed
        Integer current_row = jTableBanReasons.getSelectedRow();
        if(current_row != -1){
            InsertBanReason dialog = new InsertBanReason(new javax.swing.JFrame(), true,  Integer.parseInt(String.valueOf(jTableBanReasons.getValueAt(current_row, 0))));
            dialog.setVisible(true);
            try{
                BanReasonCleanList();
                BanReasonList();
    ...
    private javax.swing.JTable jTableBanReasons;
