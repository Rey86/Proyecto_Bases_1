...
public class ListProvince extends javax.swing.JDialog {

    public ListProvince(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void ProvinceList() throws SQLException{
    ...
    private void initComponents() {
        ...
        jTableProvinces.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jScrollPane2.setViewportView(jTableProvinces);
    ...
    private void jButtonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditActionPerformed
        ...
        if(current_row != -1){
            InsertProvince dialog = new InsertProvince(new javax.swing.JFrame(), true,  Integer.parseInt(String.valueOf(jTableProvinces.getValueAt(current_row, 0))));
    ...
    private void jButtonInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonInsertActionPerformed
        InsertProvince dialog = new InsertProvince(new javax.swing.JFrame(), true, 0);
        dialog.setVisible(true);
        try{
            ProvinceCleanList();
            ProvinceList();
