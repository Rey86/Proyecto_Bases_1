...
CREATE TABLE USERAPP(
    ...
    date_last_modification DATE CONSTRAINT userapp_datelastmodification_nn NOT NULL,
    user_last_modification varchar2(15) CONSTRAINT userapp_user_last_modification_nn NOT NULL
    );
...
CREATE TABLE USERTYPE(
    ...
    date_last_modification DATE CONSTRAINT usertype_datelastmodification_nn NOT NULL,
    user_last_modification varchar2(15) CONSTRAINT usertype_user_last_modification_nn NOT NULL
    );
...
CREATE TABLE BANREASON(
    ...
    date_last_modification DATE CONSTRAINT banreason_datelastmodification_nn NOT NULL,
    user_last_modification varchar2(15) CONSTRAINT banreason_user_last_modification_nn NOT NULL
    );