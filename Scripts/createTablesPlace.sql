...
CREATE TABLE COMMUNITY(
    ...
    user_creation varchar2(15) CONSTRAINT community_datecreation_nn NOT NULL,
    date_last_modification DATE CONSTRAINT community_datelastmodification_nn NOT NULL,
    user_last_modification varchar2(15) CONSTRAINT community_user_last_modification_nn NOT NULL
    );
...
CREATE TABLE DISTRICT(
    ...
    user_creation varchar2(15) CONSTRAINT district_datecreation_nn NOT NULL,
    date_last_modification DATE CONSTRAINT district_datelastmodification_nn NOT NULL,
    user_last_modification varchar2(15) CONSTRAINT district_user_last_modification_nn NOT NULL
    );
...
CREATE TABLE CANTON(
    ...
    user_creation varchar2(15) CONSTRAINT canton_datecreation_nn NOT NULL,
    date_last_modification DATE CONSTRAINT canton_datelastmodification_nn NOT NULL,
    user_last_modification varchar2(15) CONSTRAINT canton_user_last_modification_nn NOT NULL
    );
...
CREATE TABLE PROVINCE(
    ...
    user_creation varchar2(15) CONSTRAINT province_datecreation_nn NOT NULL,
    date_last_modification DATE CONSTRAINT province_datelastmodification_nn NOT NULL,
    user_last_modification varchar2(15) CONSTRAINT province_user_last_modification_nn NOT NULL
    );
