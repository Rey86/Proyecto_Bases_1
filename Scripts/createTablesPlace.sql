...
CREATE TABLE COMMUNITY(
    ...
    date_last_mod DATE CONSTRAINT community_datelastmodification_nn NOT NULL,
    user_last_mod varchar2(15) CONSTRAINT community_userlastmodification_nn NOT NULL
    );
...
CREATE TABLE DISTRICT(
    ...
    date_last_mod DATE CONSTRAINT district_datelastmodification_nn NOT NULL,
    user_last_mod varchar2(15) CONSTRAINT district_userlastmodification_nn NOT NULL
    );
...
CREATE TABLE CANTON(
    ...
    date_last_mod DATE CONSTRAINT canton_datelastmodification_nn NOT NULL,
    user_last_mod varchar2(15) CONSTRAINT canton_userlastmodification_nn NOT NULL
    );
...
CREATE TABLE PROVINCE(
    ...
    date_last_mod DATE CONSTRAINT province_datelastmodification_nn NOT NULL,
    user_last_mod varchar2(15) CONSTRAINT province_userlastmodification_nn NOT NULL
    );
